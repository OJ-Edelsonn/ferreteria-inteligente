...
$pageTitle = BUSINESS_NAME . ' - Catálogo inteligente';
$activePage = 'inicio';
    ...
    <main>
            ...
            <div class="container">
                <div class="row align-items-center g-4">
                    <div class="col-lg-7">
                        ...
                        <p class="lead">
                            Revisa productos disponibles, arma una cotización y contacta por WhatsApp a J&S Ferretería para confirmar precios, stock o servicios de obra.
                        </p>
                        <div class="d-flex flex-wrap gap-2 mt-4">
                            <a class="btn btn-danger" href="<?= e(BASE_URL) ?>/catalogo.php">Explorar catálogo</a>
                    ...
                    <div class="col-lg-5">
                        <div class="metric-panel">
                            ...
                            <p>Materiales de construcción, herramientas, electricidad, pintura, gasfitería y más.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="quick-actions-grid">
                    ...
                    <a class="quick-action" href="<?= e(BASE_URL) ?>/cotizador.php">
                        ...
                        <span>Selecciona productos y envía tu lista por WhatsApp.</span>
                    </a>
                    <a class="quick-action" href="<?= e(BASE_URL) ?>/servicios.php">
                        <strong>Servicios de obra</strong>
                        <span>Consulta por construcción, remodelación y acabados.</span>
                    </a>
                    <a class="quick-action" href="<?= e(BASE_URL) ?>/contacto.php">
                        <strong>Ubicación y contacto</strong>
                        <span>Encuentra la ferretería y escribe directamente.</span>
                    </a>
                </div>
            </div>
        </section>
        ...
        <section class="purchase-flow-section">
            <div class="container">
                <div class="section-kicker">
                    <p class="eyebrow">Compra práctica</p>
                ...
                <div class="purchase-flow-grid">
                    <div class="purchase-flow-item">
                        ...
                        <p>Encuentra cemento, tubos, pinturas, herramientas y accesorios desde el catálogo completo.</p>
                    </div>
                    <div class="purchase-flow-item">
                        <span>02</span>
                        <strong>Arma tu cotización</strong>
                        <p>Selecciona productos, cantidades y envía tu lista para confirmar precio y disponibilidad.</p>
                    </div>
                    <div class="purchase-flow-item">
                        <span>03</span>
                        <strong>Coordina entrega o servicio</strong>
                        <p>Contacta a J&S Ferretería para compras locales o apoyo de maestro albañil en tu obra.</p>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                ...
                <?php if (!$dbOk): ?>
                    <div class="alert alert-warning">
                        La aplicación está lista, pero falta importar la base de datos o revisar la conexión.
                        <br>
                        <small><?= e($error) ?></small>
                    </div>
                <?php endif; ?>
                ...
                <div class="category-overview-grid">
                    <?php foreach ($categoriasResumen as $categoria): ?>
                        <a class="category-overview-card" href="<?= e(BASE_URL) ?>/catalogo.php?categoria=<?= e($categoria['id']) ?>">
                            ...
                            <p><?= e($categoria['descripcion'] ?? 'Productos disponibles en catálogo') ?></p>
                        </a>
                    <?php endforeach; ?>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row g-4 align-items-center">
                    <div class="col-lg-7">
                        ...
                        <p>J&S Ferretería también conecta al cliente con servicio de maestro albañil para construcción, remodelación, instalaciones sanitarias, electricidad y acabados.</p>
                    </div>
                    <div class="col-lg-5">
                        <div class="service-action-card">
                            <strong>Presupuesto de obra</strong>
                            <span>El cliente puede solicitar una evaluación por WhatsApp y acceder a precios especiales en materiales.</span>
        ...
        <section class="guidance-section">
            <div class="container">
                <div class="row g-4 align-items-center">
                    <div class="col-lg-5">
                        <p class="eyebrow">Atención cercana</p>
                        <h2>Recibe orientación antes de comprar tus materiales.</h2>
                        <p class="guidance-copy">Consulta qué productos necesitas según tu obra, confirma disponibilidad y coordina una compra más segura por WhatsApp.</p>
                    </div>
                    <div class="col-lg-7">
                        <div class="row g-3">
                            <div class="col-md-6">
                                <div class="guidance-tile">
                                    <strong>Asesoría por tipo de trabajo</strong>
                                    <span>Te ayudamos a revisar materiales para construcción, instalaciones, pintura, gasfitería y acabados.</span>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="guidance-tile">
                                    <strong>Compra coordinada</strong>
                                    <span>Prepara tu lista, consulta precios y acuerda entrega local o apoyo de servicio de obra.</span>
                                </div>
                            </div>
                        </div>
                    </div>
